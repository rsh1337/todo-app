...
export default function CreateTaskModal({ handleSubmit_create, newTaskName_create, newTaskDetails_create, setNewTaskName_create, setNewTaskDetails_create }) {
    const { isOpen, onOpen, onClose } = useDisclosure();
    return (
        <>
            <button
                className="bg-[#F6F6F6] rounded-lg p-3 hidden md:flex flex-row md:p-2 items-center gap-2 text-sm" 
                onClick={onOpen}
            >
                <svg
                    width="25"
            ...
            <button
                className="bg-[#F6F6F6] rounded-full p-3 md:hidden"
                onClick={onOpen}
            >
                <svg
                    width="30"
                        ...
                        <form onSubmit={handleSubmit_create}>
                            <div className="flex flex-col mt-5">
                                <input
                                    ...
                                    value={newTaskName_create}
                                    onChange={(e) => setNewTaskName_create(e.target.value)}
                                ...
                                <textarea
                                    ...
                                    value={newTaskDetails_create}
                                    onChange={(e) => setNewTaskDetails_create(e.target.value)}
